...
class BusinessTitleFieldValidator extends FieldValidator {
  static const maxSymbols = 16;
  static const minSymbols = 6;

  @override
  FieldType get fieldType => FieldType.businessTitle;
  ...
  void validate(String? value) {
    ...
    if (fieldText.length > maxSymbols || fieldText.length < minSymbols) {
      throw ValidationError(
        ...
        errorMessage:
        'Description must be between $minSymbols and $maxSymbols characters.',
      );
    }
  }
}
